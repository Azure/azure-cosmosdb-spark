...
// sparkitup
ssh -C2qTnNf -D 9876 sparkuser@sparkitup-ssh.azurehdinsight.net
...
./bin/spark-shell --master spark://vivace.f1xwivc2xm4uporkjsjoixul2c.dx.internal.cloudapp.net:7077 --packages graphframes:graphframes:0.3.0-spark2.0-s_2.11 --jars /home/dennylee/spark/j2/azure-documentdb-spark-0.0.1-jar-with-dependencies.jar --executor-memory 4G --total-executor-cores 4
...
./bin/spark-shell --master spark://kintaro.f1xwivc2xm4uporkjsjoixul2c.dx.internal.cloudapp.net:7077 --packages graphframes:graphframes:0.3.0-spark2.0-s_2.11 --jars /home/dennylee/spark/j2/azure-documentdb-spark-0.0.1-jar-with-dependencies.jar --executor-memory 8G --total-executor-cores 8

// sparkitup
spark-shell --master yarn --jars /home/sparkuser/j2/azure-documentdb-spark-0.0.1-jar-with-dependencies.jar --executor-memory 8G --total-executor-cores 8
...
val coll = spark.sqlContext.read.format("com.microsoft.azure.documentdb.spark").options(readConfig2.asOptions).load()
